			...
			<div class="container-fluide">
				...
				<div class="signin-content">
					...
					<div class="signin-form">
						...
						<form method="post" action="adminee" class="register-form"
							id="login-form">
							<div class="form-group">
								<label for="username"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="adminname" id="username"
							...
							<div class="form-group form-button">
								<input type="submit" name="adminee" id="adminee"
									class="form-submit" value=" Admin Log in" />
...
<div>
							...
							<a href="login.jsp" style="color: black; padding: 5px">
								User login</a> <a href="serviceprovider.jsp"

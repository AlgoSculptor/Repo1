			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form method="post" action="" class="register-form"
						...
						<div class="form-group">
							<label for="name">Service Type</label> <input type="text"
								class="form-control" id="exampleInputEmail1"
								aria-describedby="emailHelp" name="name"
								value="<%=session.getAttribute("ServiceType")%>">
						</div>
						...
						<div class="form-group">
							<label for="name">Amount</label> <input type="text" readonly="readonly"
								class="form-control" id="exampleInputEmail1"
								aria-describedby="emailHelp" name="name" value="<%=session.getAttribute("amount") %>"
								>
						</div>
						...
						<h6 style="text-align: center">************** Thankyou Visit
							Again **************</h6>
					</form>
				</div>

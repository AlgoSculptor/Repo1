...
<script type="text/javascript">
    ...
    } else if (status == "invalidadharlength") {
    ...
    } else if (status == "invaliddob") {
        swal("sorry", "please enter Date of Birth", "error");
    }
</script>

    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        try {
          ...
          // Handle service provider removal
          String providerIdToRemove = request.getParameter("providerId");
          if (providerIdToRemove != null) {
            String deleteSql = "DELETE FROM provider WHERE id=" + providerIdToRemove;
            statement.executeUpdate(deleteSql);
            out.println("<div class='alert alert-success'>Service provider removed successfully!</div>");
          }
        ...
        <tr>
          ...
          <td>
            <form method="post" action="">
              <input type="hidden" name="providerId" value="<%= resultSet.getString("id") %>">

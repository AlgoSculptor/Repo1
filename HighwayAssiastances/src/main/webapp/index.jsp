<% if (session.getAttribute("name")==null) { response.sendRedirect("login.jsp"); } %>
	...
	<head>
		...
		<title>Highway Assistance</title> 
				...
				<div class="row">
					<div class="col-md-5">
						<img data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine"
							src="./images/about1.jpg" class="img-fluid">
					</div>
					<div class="col-md-7">
						<p data-aos="zoom-in" class="text-justify">
							...
							inter states may have more services than smaller roads. In
				...
				<div class="row p-5">
					...
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							<img class="card-img-top" src="./images/drink.jpg" alt="Card image cap">
							<div class="card-body">
					...
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							<img class="card-img-top" src="./images/insu.jpg" alt="Card image cap">
							<div class="card-body">
					...
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							<img class="card-img-top" src="./images/driving.jpg" alt="Card image cap">
							<div class="card-body">
								<h5 data-aos="flip-up" class="card-title">Licenses</h5>

								<p class="card-text text-justify">A driving license is
									government-issued proof that we can drive on the roads. Besides
									the age requirement, a driving license is issued.</p>
								<a href="#rules" class="btn btn-primary">Read_More</a>
							</div>
						</div>
					</div>
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							<img class="card-img-top" src="./images/expirecar.jpg" alt="Card image cap">
							<div class="card-body">
								<h5 data-aos="flip-up" class="card-title">Expired car</h5>
								<p class="card-text text-justify">Some quick example text to
									build on the card title and make up the bulk of the card's
									content. and perform following operations means that</p>
								<a href="#rules" class="btn btn-primary">Read_More</a>
							</div>
						</div>
					</div>
				...
				<div class="row p-5">
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							...
							<div class="card-body">
								<h5 data-aos="flip-up" class="card-title">Avoid phone while
									driving</h5>
					...
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							<img class="card-img-top" src="./images/seatbelt.jpg" alt="Card image cap">
							<div class="card-body">
								<h5 data-aos="flip-up" class="card-title">Seat belt</h5>
								<p class="card-text text-justify">Wear a seat belt/helmet
									...
									in an accident so we can take care of this to avoid</p>
								<a href="#rules" class="btn btn-primary">Read_More</a>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div data-aos="zoom-out" class="card">
							<img class="card-img-top" src="./images/trafficrules.jpg" alt="Card image cap">
							<div class="card-body">
				...
				<div class="container-fluid" style="background-color: #d0d2ce;">
					<div>
						<h1 data-aos="flip-left" class="text-center py-3">
							<span style="color: red;">F</span>requently <span style="color: red;">A</span>sked <span
								style="color: red;">Q</span>uestions
						</h1>
					</div>
						...
						<div class="card-header" id="headingTwo">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo"
									...
									<h6 style="color: black">What is Highway Assistance ?</h6>
								</button>
							</h5>
						</div>
						<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
							<div class="card-body">Highway Assistance is a network of
								technology-enabled car,bike service centers, offering a seam less
					...
					<div class="card" style="background-color: #d0d2ce">
						...
						<div id="collapseThree" class="collapse" aria-labelledby="headingThree"
							...
							<div class="card-body">Not at all. From the booking to
								...
								ease. You can still pre-pay if you choose to.</div>
						</div>
					</div>
				</div>
				</div>
						...
						<div class="container py-4">
							<div class="row gy-4 gx-5">
								<div class="col-lg-4 col-md-6">
									...
									<p class="small text-muted">"we provide emergency services
										on road!"</p>
